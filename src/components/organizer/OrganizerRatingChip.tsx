interface OrganizerRatingChipProps {
  rating: number;
  reviewCount: number;
  onClick?: () => void;
}

export const OrganizerRatingChip = ({ rating, reviewCount, onClick }: OrganizerRatingChipProps) => (
  <button
    type="button"
    onClick={onClick}
    ...
    aria-label="View organizer rating"
  >
